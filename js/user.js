$(document).ready(function() {
    ...
    $('.needs-validation').submit(function(event) {
       ...
       $('.btn.addTrigger').click(function(add){
            var user = document.getElementById(username);
            add.addEventListener(user);

            var useranzahl = userListBody + user;
            localStorage(user, useranzahl);
    ...
    $('.deleteTrigger').click(function() {
        ...
        removeEventListener('click',user);
        useranzahl = userListBody - user;

        localStorage(useranzahl);
